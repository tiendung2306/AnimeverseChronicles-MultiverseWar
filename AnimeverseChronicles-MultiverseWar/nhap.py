...
img = wizard1
img_lib = [tanker3, sword_man15, archer15, goku1, wizard1]
type_lib = ["tankerclass", "sword_manclass", "archerclass", "gokuclass" ,"wizardclass"]
x1 = 300
...
while flag:
    ...
    #display
    pygame.draw.rect(WIN, White, bottom_box, 2)            
    height = width * img.data[3] / img.data[2]
    box_rect = pygame.Rect(0, 0, width, height)
    box_rect.centerx = bottom_box.centerx
    box_rect.centery = bottom_box.bottom - height / 2
