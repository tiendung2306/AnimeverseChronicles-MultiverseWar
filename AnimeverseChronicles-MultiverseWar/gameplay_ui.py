...
class button():
    ...
    def spawn(self, side):
        if side == 1:
            spawn(self.character_type, side, 7, self.gameplay)
        elif side == 2:
            spawn(self.character_type, side, 53, self.gameplay)
...
class gameplay_ui():
    ...
    def add_button(self):
        ...
        self.character_spawn_buttons.append(button(self.gameplay.narutoclass, 'GameplayAssets\\wizard_avatar.png', self.gameplay))
